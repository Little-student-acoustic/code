function y=gn(n,rho1,rho2,rho3,a,b,omega,c1,cl2,ct2,c3)
%求导
i=sqrt(-1);
syms x1 x2 x3
...
d12=-(rho1/rho2)*((k_t2)*a)^2*besselj(n,k1*a);
...
y=det(D)/Dn(n,rho1,rho2,rho3,a,b,omega,c1,cl2,ct2,c3);
end
